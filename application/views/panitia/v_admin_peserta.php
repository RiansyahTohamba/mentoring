            ...
            <div class="panel panel-primary">
                ...
                <?php if($this->uri->segment(3) == "notifhapus") : ?>                
                    <?php if($this->uri->segment(4) == "sukses") : ?>                
                        <div class="alert-success"> peserta berhasil dihapus !</div>
                    <?php elseif($this->uri->segment(4) == "gagal") : ?>
                        <div class="alert-success"> peserta gagal dihapus !</div>                
                    <?php endif; ?>
                <?php endif; ?>    
                <?php if($this->uri->segment(3) == "notiftambah") : ?>                
                    <?php if($this->uri->segment(4) == "sukses") : ?>                
                        <div class="alert-success"> peserta berhasil ditambahkan !</div>
                    <?php elseif($this->uri->segment(4) == "gagal") : ?>
                        <div class="alert-success"> peserta gagal ditambahkan !</div>                
                    <?php endif; ?>
                <?php endif; ?>    
                
                <div class="panel-body">
                    <div class="table table-responsive">
                        <a href="<?php echo base_url('panitia/peserta/aktivasi');?>">
                            ...
                            <tbody>
                                ...
                                foreach ($peserta as $index) {
                                    ...
                                    echo "<td><button class='btn btn-outline btn-success' data-toggle='modal' data-target='.bs-example-modal-lg'> Edit</button>
                                        <button class='btn btn-outline btn-danger' data-toggle='modal' data-target='.modal-hapus-$nrp'> Hapus</button>
                    ...
                    <!--MODAL-->
                    <?php foreach ($peserta as $index) { ?>
                    <?php $nrp = $index->nrp?>
                    <!--modal hapus-->
                    <div class="<?php echo "modal fade modal-hapus-$nrp" ?>" tabindex="-1" role="dialog" 
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="<?php echo base_url('panitia/peserta/hapus/' . $nrp)?>">
                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                    <h4 class="modal-title" id="myModalLabel">Aktivasi Mahasiswa Untuk Menjadi Peserta</h4>
                                </div>
                                <div class="modal-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($calon_peserta as $index) {
                                                    ...
                                                    echo "<td>" . $nama . "</td>";
                                                    echo "<td>" . $jurusan . "</td>";
                                                    echo "<td><a href='" . site_url('panitia/peserta/tambah/' . $nrp) . "' class='btn btn-outline btn-success'> aktivasi</a></td>";
                                                };
                                                ?>
                                            </tbody>
                                        </table>
