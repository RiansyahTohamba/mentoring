            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="table table-responsive">
                        <a href="<?php echo base_url('panitia/pengajar/aktivasi');?>" class="btn btn-primary" ><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?php echo base_url('panitia/pengajar/hapus/' . $id) ?>"><button type="button" class="btn btn-primary">Ya</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                echo "<td>" . $nama . "</td>";
                                                echo "<td>" . $jurusan . "</td>";
                                                echo "<td><a href='" . site_url('panitia/pengajar/tambah/' . $nrp) . "' "
