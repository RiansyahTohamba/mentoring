<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Calon Peserta</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <i class="fa fa-users fa-fw"></i> Daftar Calon Peserta
                </div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                foreach ($calon_peserta as $index) {
                                    ...
                                    echo "
                                        <td>
                                        <a href='" . site_url('panitia/peserta/tambah/' . $nrp) . "' class='btn btn-outline btn-success'> Aktivasi</a>                                        
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($calon_peserta as $index) {
                                                    ...
                                                    echo "<td>" . $nama . "</td>";
                                                    echo "<td>" . $jurusan . "</td>";
                                                    echo "<td><a href='" . site_url('admin/peserta/tambah/' . $nrp) . "' class='btn btn-outline btn-success'> aktivasi</a></td>";
                                                };
                                                ?>
                                            </tbody>
                                        </table>
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="<?php echo base_url('panitia/peserta/hapus/' . $nrp) ?>"><button type="button" class="btn btn-primary">Ya</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
