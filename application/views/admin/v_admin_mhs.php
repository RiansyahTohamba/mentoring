                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form class="form-group has-success" action="" >
                                        <div class="control-group">
                                            <label class="control-label" for="nrp">NRP</label>
                                            <input class="form-control" type="text" id="nrp" placeholder="NRP Anda">
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <input class="form-control" type="text" id="jurusan" placeholder="Jurusan">
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="fakultas">Fakultas</label>                                                  
                                            <input class="form-control" type="text" id="fakultas" placeholder="Fakultas">
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <input class="form-control" type="text" id="kontak" placeholder="No.Hp/Telepon">
                                        </div>
