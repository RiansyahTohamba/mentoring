...
<div class="navbar-default sidebar" role="navigation" style="margin-top: 100px ">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            ?>  
                href="<?php echo site_url('pengajar/profile'); ?>"><i class="fa fa-fw fa-user"></i> Profil</a>
            </li>
            <li> <a class='hijau' <?php
            ...
            <li> <a class='hijau' <?php
            if ($this->uri->segment(2) == "catatan") {
                echo 'class="active"';
            }
            ?>
                 href="<?php echo site_url('pengajar/catatan'); ?>"><i class="glyphicon glyphicon-comment"></i> Catatan</a>
            </li>                              
